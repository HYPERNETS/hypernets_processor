...
class Average:
    ...
    def average_l1b(self, measurandstring, dataset_l0, dataset_l0_bla, calibration_data):
        ...
        dataset_l1b=calibrate_function.propagate_ds_specific(["systematic_corr_rad_irr"],dataset_l0b,calibration_data,ds_out_pre=dataset_l1b,store_unc_percent=True)
