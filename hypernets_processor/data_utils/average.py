...
class Average:
    ...
    def average_l1b(self, measurandstring, dataset_l0, dataset_l0_bla, calibration_data):
        ...
        print(dataset_l0b["digital_number"].values,dataset_l0b["dark_signal"].values,dataset_l0b["integration_time"].values,calibration_data["non_linearity_coefficients"].values,calibration_data["gains"].values)
        print(dataset_l0b["u_random_digital_number"].values,dataset_l0b["u_random_dark_signal"].values,calibration_data["u_systematic_indep_gains"].values)
