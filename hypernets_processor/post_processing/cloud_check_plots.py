...
data = np.loadtxt(
    r"C:/Users/jr20/code/hypernets_cloud_checks/first_cc_0875.csv", delimiter=","
)
...
ax.plot(
    tols, aod_1_outs, label="AOD = 0.1: Outliers", color="orange", linestyle="solid"
)
ax.plot(
    tols, aod_1_good, label="AOD = 0.1: Good Data", color="orange", linestyle="dotted"
)
ax.plot(tols, aod_2_outs, label="AOD = 0.2: Outliers", color="blue", linestyle="solid")
ax.plot(
    tols, aod_2_good, label="AOD = 0.2: Good Data", color="blue", linestyle="dotted"
)
ax.plot(tols, aod_3_outs, label="AOD = 0.3: Outliers", color="green", linestyle="solid")
ax.plot(
    tols, aod_3_good, label="AOD = 0.3: Good Data", color="green", linestyle="dotted"
)
