...
class MetadataUtil:
    ...
    @staticmethod
    def _create_file_name_l1a_rad(network, site, time, version):
        """
    ...
    @staticmethod
    def _create_file_name_l1a_irr(network, site, time, version):
        """
    ...
    @staticmethod
    def _create_file_name_l1b(network, site, time, version):
        """
        Return a valid file name for Hypernets Level 1a irradiance file
    ...
    @staticmethod
    def _create_file_name_l2a(network, site, time, version):
        """
    ...
    @staticmethod
    def _create_file_name_l2b(network, site, time, version):
        """
