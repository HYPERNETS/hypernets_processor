...
W_L1B_VARIABLES = { "upwelling_radiance": {"dim": [WL_DIM,SEQ_DIM],
                                           "dtype": np.float32,
                                           "attributes": {"standard_name": "upwelling_radiance_per_unit_wavelength_in_air",
                                                          "long_name": "Upwelling radiation is radiation from below. It does not mean net upward. The sign convention is that upwelling is positive upwards and "downwelling" is positive downwards. Radiance is the radiative flux in a particular direction, per unit of solid angle. The direction towards which it is going must be specified, for instance with a coordinate of zenith_angle.",
                                                          "reference": [SYSTEM_HEIGHT_DEPLOYEMENT],
                                                          "units": "mW m^-2 nm^-1 sr^-1",
                                                          "NRC URI":"http://vocab.nerc.ac.uk/collection/P01/current/TTWTIR01/",
                                                          "preferred_symbol": "lu"},
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.1, "offset": 0.0}},
                   "downwelling_radiance": {"dim": [WL_DIM,SEQ_DIM],
                                            "dtype": np.float32,
                                            "attributes": {"standard_name": "downwelling_radiance_per_unit_wavelength_in_air",
                                                           "long_name": "Downwelling radiation is radiation from above. It does not mean "net downward". The sign convention is that "upwelling" is positive upwards and "downwelling" is positive downwards. A coordinate variable for radiation wavelength should be given the standard name radiation_wavelength. Radiance is the radiative flux in a particular direction, per unit of solid angle. The direction from which it is coming must be specified, for instance with a coordinate of zenith_angle.",
                                                           "reference": [SYSTEM_HEIGHT_DEPLOYEMENT],
                                                           "units": "mW m^-2 nm^-1 sr^-1",
                                                           "NRC URI":"http://vocab.nerc.ac.uk/collection/P01/current/SKYIRR01/",
                                                           "preferred_symbol": "ld"},
                                            "encoding": {'dtype': np.uint16, "scale_factor": 0.1, "offset": 0.0}},
                   "downwelling_irradiance": {"dim": [WL_DIM,SEQ_DIM],
                                              "dtype": np.float32,
                                              "attributes":{"standard_name":"downwelling_irradiance_per_unit_wavelength_in_air",
                                                             "long_name": "Downwelling vector irradiance as energy of electromagnetic radiation (unspecified single wavelength) in the atmosphere by cosine-collector radiometer",
                                                            "reference": [SYSTEM_HEIGHT_DEPLOYEMENT],
                                                            "units": "mW m^-2 nm^-1",
                                                            "NRC URI":"http://vocab.nerc.ac.uk/collection/P01/current/CSLRCCR1/",
                                                            "preferred_symbol": "ed"},
                                              "encoding": {'dtype': np.uint16, "scale_factor": 0.1, "offset": 0.0}},
                   "surface_reflectance": {"dim": [WL_DIM,SEQ_DIM],
                                           "dtype": np.float32,
                                           "attributes":{"standard_name":"surface_upwelling_radiance_per_unit_wavelength_in_air_reflected_by_water",
                                                             "long_name": "The surface called "surface" means the lower boundary of the atmosphere. Upwelling radiation is radiation from below. It does not mean "net upward". The sign convention is that "upwelling" is positive upwards and "downwelling" is positive downwards. Radiance is the radiative flux in a particular direction, per unit of solid angle. The direction towards which it is going must be specified, for instance with a coordinate of zenith_angle. ",
                                                         "reference": [SYSTEM_HEIGHT_DEPLOYEMENT],
                                                         "units": "-",
                                                         "preferred_symbol": "ls"},
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.1, "offset": 0.0}},
                   "rhof": {"dim": [WL_DIM,SEQ_DIM],
                                           ...
                                           "attributes":{"standard_name":"fresnel_reflectance",
                                                         "long_name":"Fraction of downwelling sky radiance reflected at the air-water interface",
                                                         "reference": [SYSTEM_HEIGHT_DEPLOYEMENT],
                                                         "units": "-",
                   ...
                   "fresnel_wind": {"dim": [SEQ_DIM],
                                           ...
                                           "attributes":{"standard_name":"fresnel_wind",
                                                         "long_name": "Surface wind speed used for the retrieval of the fraction of downwelling sky radiance reflected at the air-water interface",
                                                         "reference": [SYSTEM_HEIGHT_DEPLOYEMENT],
                                                         "units": "ms^-1"},
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.1, "offset": 0.0}},
                   "fresnel_sza": {"dim": [SEQ_DIM],
                                           ...
                                           "attributes":{"standard_name":"fresnel_solar_zenith_angle",
                                                         "long_name": "Solar zenith angle used for the retrieval of the fraction of downwelling sky radiance reflected at the air-water interface",
                                                         "reference": [SYSTEM_HEIGHT_DEPLOYEMENT],
                                                         "units": "degrees"},
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.1, "offset": 0.0}},
                   "fresnel_raa": {"dim": [SEQ_DIM],
                                           ...
                                           "attributes":{"standard_name":"fresnel_relative_azimuth_angle",
                                                         "long_name": "Relative azimuth angle from sun to sensor (0° when sun and sensor are aligned 180° when the sensor is looking into the sunglint) used for the retrieval of the fraction of downwelling sky radiance reflected at the air-water interface",
                                                         "reference": [SYSTEM_HEIGHT_DEPLOYEMENT],
                                                         "units": "degrees"},
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.1, "offset": 0.0}},
                   "fresnel_vza": {"dim": [SEQ_DIM],
                                           ...
                                           "attributes":{"standard_name":"fresnel_sensor_zenith_angle",
                                                         "long_name": "Sensor zenith angle used for the retrieval of the fraction of downwelling sky radiance reflected at the air-water interface",
                                                         "reference": [SYSTEM_HEIGHT_DEPLOYEMENT],
                                                         "units": "degrees"},
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.1, "offset": 0.0}}
...
# W_L2A_VARIABLES - Variables required for the water network L1A data product (in addition to COMMON_VARIABLES)
W_L2A_VARIABLES = {}
