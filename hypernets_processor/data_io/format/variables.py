...
L0B_RAD_VARIABLES = {"integration_time": {"dim": [SERIES_DIM],
                                         "dtype": np.uint32,
                                         "attributes": {"standard_name": "integration_time",
                                                        "long_name": "Integration time during measurement",
                                                        "units": "s"},
                                         "encoding": {"dtype": np.uint32}},
                    "temperature": {"dim": [SERIES_DIM],
                                    "dtype": np.float32,
                                    "attributes": {"standard_name": "temperature",
                                                   "long_name": "temperature of instrument",
                                                   "units": "degrees"},
                    ...
                    "acceleration_z_std": {"dim": [SERIES_DIM],
                                           ...
                                           "attributes": {"standard_name": "acceleration_z_std",
                                                          ...
                                                          "units": "-"},
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.01, "offset": 0.0}},
                     "digital_number": {"dim": [WL_DIM, SERIES_DIM],
                                        "dtype": np.uint32,
                                        "attributes": {"standard_name": "digital_number",
                                                       "long_name": "Digital number, raw data",
                                                       "units": "-",
                     ...
                     "dark_signal": {"dim": [WL_DIM, SERIES_DIM],
                                        "dtype": np.uint32,
...
CAL_VARIABLES = {"wavelength": {"dim": [WL_DIM],
                 ...
                 "u_rel_systematic_corr_rad_irr_gains": {"dim": [CD_DIM,WL_DIM],
                                           ...
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.01, "offset": 0.0}},
                 "err_corr_systematic_indep_gains":{"dim":[CD_DIM,WL_DIM,WL_DIM],
                 ...
                 "err_corr_systematic_corr_rad_irr_gains":{"dim":[CD_DIM,WL_DIM,WL_DIM],
                                                          "dtype":np.float32,"attributes":{
...
L1A_RAD_VARIABLES = {"u_rel_random_radiance": {"dim": [WL_DIM, SCAN_DIM],
                     ...
                     "u_rel_systematic_corr_rad_irr_radiance": {"dim": [WL_DIM, SCAN_DIM],
                                               ...
                                               "encoding": {'dtype': np.uint16, "scale_factor": 0.01, "offset": 0.0}},
                     "err_corr_systematic_indep_radiance": {"dim": [WL_DIM, WL_DIM],
                                                  "dtype": np.float32,
                                                  "attributes": {
                     ...
                     "err_corr_systematic_corr_rad_irr_radiance": {"dim": [WL_DIM, WL_DIM],
                                                  "dtype": np.float32,
                                                  "attributes": {
...
L1A_IRR_VARIABLES = {"u_rel_random_irradiance": {"dim": [WL_DIM, SCAN_DIM],
                     ...
                     "u_rel_systematic_corr_rad_irr_irradiance": {"dim": [WL_DIM, SCAN_DIM],
                                                 ...
                                                 "encoding": {'dtype': np.uint16, "scale_factor": 0.01, "offset": 0.0}},
                     "err_corr_systematic_indep_irradiance": {"dim": [WL_DIM, WL_DIM],
                                                    "dtype": np.float32,
                                                    "attributes": {
                                                        ...
                                                        "units": "-"},
                                                    "encoding": {'dtype': np.int8, "scale_factor": 0.01, "offset": 0.0}},
                     "err_corr_systematic_corr_rad_irr_irradiance": {"dim": [WL_DIM, WL_DIM],
                                                    "dtype": np.float32,
                                                    "attributes": {
...
W_L1C_VARIABLES = {"u_rel_random_downwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                   ...
                   "u_rel_systematic_corr_rad_irr_downwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                         ...
                                                         "encoding": {'dtype': np.uint16, "scale_factor": 0.01, "offset": 0.0}},
                   "err_corr_systematic_indep_downwelling_radiance": {"dim": [WL_DIM, WL_DIM],
                                                            "dtype": np.float32,
                                                            "attributes": {
                                                                "standard_name": "independent correlation matrix of systematic error on radiance",
                                                                "long_name": "Correlation matrix bewtween wavelengths for the systematic error component on radiance that is not correlated with irradiance",
                                                                "units": "-"},
                                                            "encoding": {'dtype': np.int8, "scale_factor": 0.01, "offset": 0.0}},
                   "err_corr_systematic_corr_rad_irr_downwelling_radiance": {"dim": [WL_DIM, WL_DIM],
                                                            "dtype": np.float32,
                                                            "attributes": {
                   ...
                   "u_rel_systematic_corr_rad_irr_upwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                       ...
                                                       "encoding": {'dtype': np.uint16, "scale_factor": 0.01, "offset": 0.0}},
                   "err_corr_systematic_indep_upwelling_radiance": {"dim": [WL_DIM, WL_DIM],
                                                          "dtype": np.float32,
                                                          "attributes": {
                                                              "standard_name": "independent correlation matrix of systematic error on radiance",
                                                              "long_name": "Correlation matrix bewtween wavelengths for the systematic error component on radiance that is not correlated with irradiance",
                                                              "units": "-"},
                                                          "encoding": {'dtype': np.int8, "scale_factor": 0.01, "offset": 0.0}},
                   "err_corr_systematic_corr_rad_irr_upwelling_radiance": {"dim": [WL_DIM, WL_DIM],
                                                          "dtype": np.float32,
                                                          "attributes": {
                                                              "standard_name": "correlation matrix of systematic error on radiance",
                                                              "long_name": "Correlation matrix bewtween wavelengths for the systematic error component on radiance that is correlated with irradiance",
...
L_L2A_REFLECTANCE_VARIABLES = {"u_rel_random_reflectance": {"dim": [WL_DIM, SERIES_DIM],
                               ...
                               "u_rel_systematic_reflectance": {"dim": [WL_DIM, SERIES_DIM],
                                                            ...
                                                            "encoding": {'dtype': np.uint16, "scale_factor": 0.01, "offset": 0.0}},
                               "err_corr_systematic_reflectance": {"dim": [WL_DIM, WL_DIM],
                                                               "dtype": np.float32,
                                                               "attributes": {
...
W_L1C_REFLECTANCE_VARIABLES = {"reflectance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                               ...
                               "u_rel_systematic_water_leaving_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                                       ...
                                                                       "encoding": {'dtype': np.uint16,
                                                                                    "scale_factor": 0.01,
                                                                                    "offset": 0.0}},
                               "err_corr_systematic_water_leaving_radiance": {"dim": [WL_DIM, WL_DIM],
                                                                          "dtype": np.float32,
                                                                          "attributes": {
                                                                              "standard_name":
                                                                                  "err_corr_systematic_normalized_water_leaving_radiance",
                                                                              "long_name":
                               ...
                               "u_rel_systematic_reflectance_nosc": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                                 ...
                                                                 "encoding": {'dtype': np.uint16,
                                                                              "scale_factor": 0.01,
                                                                              "offset": 0.0}},
                               "err_corr_systematic_reflectance_nosc": {"dim": [WL_DIM, WL_DIM],
                                                                    "dtype": np.float32,
                                                                    "attributes": {
                                                                        "standard_name":
                                                                            "err_corr_systematic_water_leaving_reflectance_nosc",
...
VARIABLES_DICT_DEFS: Any = {"L0_RAD": {**COMMON_VARIABLES_SCAN, **C_QUALITY_SCAN, **L0_RAD_VARIABLES},
                            ...
                            "L_L0B": {**COMMON_VARIABLES_SERIES, **L_QUALITY, **L0B_RAD_VARIABLES},
                            "CAL": {**CAL_VARIABLES},
