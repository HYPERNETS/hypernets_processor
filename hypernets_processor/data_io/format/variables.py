...
COMMON_VARIABLES_SERIES = {"wavelength": {"dim": [WL_DIM],
                                          ...
                                          "attributes": {"standard_name": "wavelength",
                                                         ...
                                                         "units": "nm",
                                                         "preferred_symbol": "wv"},
                                          "encoding": {'dtype': 'uint16', "scale_factor": 0.025, "offset": 320}},
                           "bandwidth": {"dim": [WL_DIM],
                                         "dtype": 'float32',
                                         "attributes": {},
                                         "encoding": {'dtype': 'uint16', "scale_factor": 0.1, "offset": 0.0}},
                           "viewing_azimuth_angle": {"dim": [SERIES_DIM],
                                                     ...
                                                     "encoding": {'dtype': 'uint16', "scale_factor": 0.0055,
                                                                  "offset": 0.0}},
                           "viewing_zenith_angle": {"dim": [SERIES_DIM],
                                                    ...
                                                    "encoding": {'dtype': 'uint16', "scale_factor": 0.0028,
                                                                 "offset": 0.0}},
...
L0_RAD_VARIABLES = {"integration_time": {"dim": [SCAN_DIM],
                    ...
                    "acceleration_x_mean": {"dim": [SCAN_DIM],
                                            ...
                                            "attributes": {"standard_name": "acceleration_x_mean",
                                                           ...
                                                           "units": "-"},
                                            "encoding": {'dtype': 'uint16', "scale_factor": 0.01, "offset": 0.0}},
...
CAL_VARIABLES = {"wavelengths": {"dim": [CD_DIM,WL_DIM],
                 ...
                 #                                          "units": "-"},
                 #                           "encoding": {'dtype': 'uint32', "scale_factor": 0.001, "offset": 0.0}},
                 "u_rel_systematic_indep_gains": {"dim": [CD_DIM,WL_DIM],
                                              ...
                                              "attributes": {"standard_name": "independent systematic relative uncertainty on gains",
                                                          ...
                                                          "units": "-"},
                                              "encoding": {'dtype': 'uint16', "scale_factor": 0.0001, "offset": 0.0}},
                 "u_rel_systematic_corr_rad_irr_gains": {"dim": [CD_DIM,WL_DIM],
                                           ...
                                           "attributes": {"standard_name": "systematic relative uncertainty on gains (correlated radiance and irradiance)",
                                                          ...
                                                          "units": "-"},
                                           "encoding": {'dtype': 'uint16', "scale_factor": 0.0001, "offset": 0.0}},
                 # "corr_random_gains":{"dim":[WL_DIM,WL_DIM],"dtype":'int16',
                 #                         "attributes":{
                 ...
                 "corr_systematic_indep_gains":{"dim":[CD_DIM,WL_DIM,WL_DIM],
                         ...
                         "units":"-"},
                         "encoding":{'dtype':'int16',"scale_factor":0.0001,"offset":0.0}
                                                },
                 ...
                 #                                          "units": "-"},
                 #                           "encoding": {'dtype': 'uint32', "scale_factor": 0.001, "offset": 0.0}},
                 # "corr_random_non_linearity_coefficients":{"dim":[NL_DIM,NL_DIM],"dtype":'int16',
                 #                         "attributes":{
...
L1A_RAD_VARIABLES = {"u_rel_random_radiance": {"dim": [WL_DIM, SCAN_DIM],
                     ...
                     "corr_random_radiance": {"dim": [WL_DIM, WL_DIM],
                                              ...
                                              "attributes": {
                                                  ...
                                                  "units": "-"},
                                              "encoding": {'dtype': 'int8', "scale_factor": 0.01, "offset": 0.0}},
...
W_L1C_REFLECTANCE_VARIABLES = {"reflectance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                               ...
                               "reflectance_nosc": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                    ...
                                                    "encoding": {'dtype': 'uint16', "scale_factor": 0.0001,
                                                                 "offset": 0.0}},
                               ...
                               "epsilon": {"dim": [Lu_SCAN_DIM],
                                           ...
                                           "attributes": {"standard_name": "simil_epsilon",
                                                          ...
                                                          "reference": "",
                                                          "units": "-"},
                                           "encoding": {'dtype': 'uint16', "scale_factor": 0.001, "offset": 0.0}},
