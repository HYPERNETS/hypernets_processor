...
INSTRUMENT_METADATA = {"instrument_id": "NaN",
...
PAN_TILT_METADATA = {"pointing_system_id": "TBD",
...
CALIBRATION_DEVICE_METADATA = {"calibration_device_id": "TBD",
...
IRR_HEAD_METADATA = {"irr_vis_head_id": "TBD",
...
RAD_HEAD_METADATA = {"rad_vis_head_id": "TBD",
...
RAIN_SENSOR_METADATA = {"rain_sensor_id": "TBD",
                        "rain_sensor_manufacturer": "KemoElectronic",
                        "rain_sensor_date_manufacture": "TBD"}

RGB_CAMERA_METADATA = {"rgb_camera_id": "TBD",
...
L_SYSTEM_METADATA = {**STANDARD_METADATA, **COMPONENTS_METADATA,
                     ...
                     **SITE_METADATA, **LAND_NETWORK_METADATA, **NETWORK_METADATA}
W_SYSTEM_METADATA = {**STANDARD_METADATA, **COMPONENTS_METADATA,
                     **SYSTEM_METADATA, **INSTRUMENT_METADATA, **RAD_HEAD_METADATA, **IRR_HEAD_METADATA,
                     **CALIBRATION_DEVICE_METADATA,
                     **RAIN_SENSOR_METADATA, **RGB_CAMERA_METADATA, **PAN_TILT_METADATA,
                     **SITE_METADATA, **WATER_NETWORK_METADATA, **NETWORK_METADATA}

METADATA_DEFS = {"L0_RAD": {**STANDARD_METADATA, **COMPONENTS_METADATA},
                 "L0_IRR": {**STANDARD_METADATA, **COMPONENTS_METADATA},
                 "L0_BLA": {**STANDARD_METADATA, **COMPONENTS_METADATA},
                 "CAL": {**CAL_METADATA, **SYSTEM_METADATA, **INSTRUMENT_METADATA, **RAD_HEAD_METADATA,
                         **IRR_HEAD_METADATA,
                         **CALIBRATION_DEVICE_METADATA},
                 ...
                 "W_L1B": {**STANDARD_METADATA, **COMPONENTS_METADATA, **WATER_NETWORK_METADATA, **L1A_IRR_METADATA,
                           **L1A_RAD_METADATA},
                 ...
                 "W_L1D": {**STANDARD_METADATA, **COMPONENTS_METADATA, **WATER_NETWORK_METADATA, **W_L1C_WLR_METADATA},
