...
class HypernetsProcessor:
    ...
    def run(self):
        ...
        calibration_data["dark_signal"] = np.zeros(len(ds_rad["wavelength"]))
        ...
        L1_rad=cal.calibrate("radiance",ds_rad,calibration_data,measurement_function='StandardMeasurementFunction')
